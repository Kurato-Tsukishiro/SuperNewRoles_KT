...
namespace SuperNewRoles
{
    ...
    public static class RoleHelpers
    {
        ...
        public static void setRole(this PlayerControl player, RoleId role)
        {
            switch (role)
            {
                ...
                case (CustomRPC.RoleId.Vampire):
                    ...
                    break;
                case (CustomRPC.RoleId.Tracker):
                    Roles.RoleClass.Tracker.TrackerPlayer.Add(player);
                    break;
                //ロールアド
                default:
        ...
        public static void ClearRole(this PlayerControl player)
        {
            ...
            switch (player.getRole())
            {
                ...
                case (CustomRPC.RoleId.Observer):
                    ...
                    break;
                case (CustomRPC.RoleId.Tracker):
                    Roles.RoleClass.Tracker.TrackerPlayer.RemoveAll(ClearRemove);
                    break;
                //ロールリモベ
        ...
        public static RoleId getRole(this PlayerControl player,bool IsChache = true)
        {
            ...
            else if (Roles.RoleClass.Tracker.TrackerPlayer.IsCheckListPlayerControl(player))
            {
                return CustomRPC.RoleId.Tracker;
            }
            //ロールチェック
